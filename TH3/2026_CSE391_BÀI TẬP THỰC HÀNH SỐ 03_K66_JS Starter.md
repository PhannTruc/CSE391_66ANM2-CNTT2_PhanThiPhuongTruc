...
Khi trang web được tải, JavaScript được trình duyệt thực thi và in thông báo ra Console để kiểm tra code
---
...
Trong trình duyệt (client-side) như Chrome, Edge
Trên server (server-side) với Node.js
> b) HTML, CSS, JavaScript mỗi phần chịu trách nhiệm chính về điều gì?
>
> - HTML: tạo cấu trúc nội dung của trang web (tiêu đề, đoạn văn, bảng, hình ảnh).
> - CSS: dùng để thiết kế giao diện (màu sắc, bố cục, font chữ).
> - JavaScript: dùng để tạo sự tương tác và xử lý logic cho trang web.
...
>   - `number` là: kiểu dữ liệu số (ví dụ: 1, 2, 10.5)
>   - `string` là: chuỗi ký tự (ví dụ: "Hello")
>   - `boolean` là: giá trị đúng hoặc sai (true hoặc false)
...
Hello from JavaScript!
Xin chào, mình là Truc, năm nay mình 20 tuổi.
> - Nếu em quên dấu `;` hoặc quên dấu `+`, điều gì xảy ra? Trình duyệt báo lỗi thế nào?
Quên ; -> thường lỗi không nghiêm trọng
Quên + trình duyệt báo lỗi : Uncaught SyntaxError
---

#### Bước 5: Phản tư nhanh (Reflection)

> - Điều thú vị nhất em vừa khám phá được về console là gì?
Console giúp kiểm tra kết quả code và phát hiện lỗi nhanh chóng
> - Em gặp lỗi cú pháp nào? Em đã xử lý bằng cách nào (tự sửa, hỏi bạn, đọc lỗi, tìm Google, …)?
Sai cú pháp hoặc quên dấu +, em đọc lỗi trong console và sửa lại code
---
...
Chương trình sẽ kiểm tra điều kiện và đi theo nhánh phù hợp
...
>   - Thân hàm (body): phần code bên trong { }
...
Xảy ra khi người dùng nhấn chuột vào phần tử
> - Trong đoạn code trên, khi nhấn nút `btnHello`, điều gì thay đổi trên trang?
Nội dung của đoạn <p id="status"> sẽ thay đổi bằng JavaScript
---
...
click: xảy ra khi nhấn chuột.
input: xảy ra khi người dùng nhập dữ liệu vào ô input.
...
>   .DOM là mô hình cây của trang HTML, cho phép JavaScript truy cập và thay đổi nội dung của trang web.
